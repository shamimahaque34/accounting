                                ...
                                <div>
                                    <form action="{{ route('companies.update',$company->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="text" class="form-control rounded-lg" name="name_bangla" value="{{$company->name_bangla}}" data-provide="typeahead" id="the-basics" placeholder="Enter Bangla Name">
                                        </div>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="text" class="form-control rounded-lg" name="website" value="{{$company->website}}" data-provide="typeahead" id="the-basics" placeholder="Enter Website">
                                        </div>
