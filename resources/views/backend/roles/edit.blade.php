...
@section('body-title-section')
    @include('backend.includes.body-page-title-two',['parent'=>'Role  Info', 'child' =>'Edit'])
@endsection
                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="title" value="{{$role->title}}" data-provide="typeahead" id="the-basics" placeholder="Role Title">
                        </div>
                        <div class="mb-3">
