                    ...
                    <div class="col-md-8 mx-auto">
                        <div class="card mt-3">
                            <div class="card-header">
                                <h4 class="float-start" style="font-weight:700;">New Customer</h4>
                                ...
                                <div>
                                    <form action="{{ route('customers.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input type="text" class="form-control rounded-lg" name="website" value="" data-provide="typeahead" id="the-basics" placeholder="Enter Phone">
                                        </div>

                                        <div class="mb-3 col-md-4">
                                            <label class="form-label">Reference</label>
                                            <input type="text" class="form-control rounded-lg" name="reference" value="" data-provide="typeahead" id="the-basics" placeholder="Enter Phone">
                                        </div>
