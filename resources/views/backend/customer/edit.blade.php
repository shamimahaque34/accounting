                                ...
                                <div>
                                    <form action="{{ route('customers.update',$customer->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="text" class="form-control rounded-lg" name="website" value="{{$customer->website}}" data-provide="typeahead" id="the-basics" placeholder="Enter Website">
                                        </div>

                                        <div class="mb-3 col-md-6">
                                            <label class="form-label">Reference</label>
                                            <input type="text" class="form-control rounded-lg" name="reference" value="{{$customer->reference}}" data-provide="typeahead" id="the-basics" placeholder="Enter Reference">
                                        </div>
