...
<body>
  ...
  <section class="py-2" style="padding: 10px 0px;">
    <div class="container" style="margin: 0 auto; padding: 0px 18px; width: 100%;">
      <div class="row" style="display: flex">
        <div class="col-lg-6" style="width: 50%; padding:0px 8px;">
          ...
          <p class="text-muted mb-1" style="color:#6c757d;">
        ...
        <div class="col-lg-6" style="width: 50%; padding:0px 8px;">
          ...
          <div class="border border-dark border-2" style="border:1px solid black;">
            <div class="border-bottom border-dark" style="border-bottom:1px solid black;">
              <p class="ps-3 mb-0"  style="padding-left: 20px; margin-bottom:0px">Date:{{$invoice->invoice_date}}
                {{-- <script>
            ...
            <div class="border-bottom border-dark"  style="border-bottom:1px solid black;">
              <p class="ps-3 mb-0" style="padding-left: 20px; margin-bottom:0px">Bill No: {{$invoice->invoice_number}}</p>
            </div>
            <div class="border-bottom border-dark" style="border-color: dark; border-bottom:1px solid black;">
              <p class="ps-3 mb-0" style="padding-left: 20px; margin-bottom:0px">TIN Number: {{ $invoice->companyIbs->tin_no }}</p>
            </div>
            <div class="border-bottom border-dark" style="border-color: dark; border-bottom:1px solid black;">
              <p class="ps-3 mb-0" style="padding-left: 20px; margin-bottom:0px">VAT/BIN Number:{{ $invoice->companyIbs->vat_bin_no }}</p>
            </div>
            <div class="border-bottom border-dark" style="border-color: dark; border-bottom:1px solid black;">
              <p class="ps-3 mb-0" style="padding-left: 20px; margin-bottom:0px">Account Name: {{ $invoice->companyIbs->account_name }}</p>
            </div>
            <div class="border-bottom border-dark" style="border-color: dark; border-bottom:1px solid black;">
              <p class="ps-3 mb-0" style="padding-left: 20px; margin-bottom:0px">Account No: {{ $invoice->companyIbs->account_no }}</p>
            </div>
            <div class="border-bottom border-dark" style="border-color: dark;border-bottom:1px solid black;">
              <p class="ps-3 mb-0" style="padding-left: 20px; margin-bottom:0px">Bank Name: {{ $invoice->companyIbs->bank_name }}</p>
            </div>
            <div class="border-bottom border-dark" style="border-color: dark;border-bottom:1px solid black;">
              <p class="ps-3 mb-0" style="padding-left: 20px; margin-bottom:0px">Bank Branch Name: {{ $invoice->companyIbs->bank_branch_name }}</p>
            </div>
            <div>
              <p class="ps-3 mb-0" style="padding-left: 20px; margin-bottom:0px">Contact Number & Bkash Number: {{ $invoice->companyIbs->contact_number_and_bkash_number}}.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="text-center mt-3" style="text-align: center; margin-top:3px;">
        <span class="bg-dark text-white d-inline-block px-4 py-2 rounded-4 fw-bold fs-5" style="background-color: black ;color:white;display:inline-block;padding: 2px 4px;font-weight:bold;font-size:16px; border-radius:8px; margin-left:-40px">Advertising Bill
        </span>
      </div>
      <div class="row">
        <div class="col-lg-12" style="width: 100%; padding:0px 8px;">
          ...
          <div class="row" style="display: flex">
            ...
            <div class="col-lg-5 offset-lg-4" style="width: 41.66% ;padding:0px 8px;">
            ...
            <div class="col-lg-1" style="width: 8.33% ;padding:0px 8px;">
            ...
            <div class="col-lg-2" style="width: 16.66% ;padding:0px 8px;">
        ...
        $amountInWords = ucwords((new NumberFormatter('en_IN', NumberFormatter::SPELLOUT))->format($totalAmount));@endphp
          ...
          <p class="mt-2" style="margin-top:2px">
            ...
            <span class="fs-5" style="font-size: 16px">{{$amountInWords}}</span>
          </p>
          <div class="fs-5 p-1 text-white bg-secondary" style="font-size: 16px; color:white;background-color:#6c757d">
            <span class="fw-bold" style="font-weight:bold">'{{$invoice->company->name}}' নামে চেক/পে-অর্ডার/ডিডি এর মাধ্যমে বিল প্রদান করুন । </span>
          </div>
          <p class="text-center my-1 fw-bold border-bottom border-dark" style="text-align: center; margin: 0 8px;font-weight:bold; border-bottom:1px solid black;">
          ...
          <div class="row" style="display: flex">
            <div class="col-lg-3 text-center" style="text-align: center;width: 25% ;padding:0px 8px;">
          ...
          <div class="row mt-5" style="display: flex;margin-top:16px;">
            <div class="col-lg-4" style="width: 33.33% ;padding:0px 8px;">
              <p class="text-muted fw-bold fs-5" style="font-weight: bold; text-color:color:#6c757d;;font-size:16px;">
                {{$invoice->company->website}}
              </p>
            </div>
            <div class="col-lg-4" style="width: 33.33% ;padding:0px 8px;">
              <p class="text-dark fw-bold fs-5"  style="font-weight: bold; text-color:color:#6c757d;;font-size:16px; text-align:center;">
                {{$invoice->company->phone}}
              </p>
            </div>
            <div class="col-lg-4" style="width: 33.33% ;padding:0px 8px;">
              <p class="text-muted fw-bold fs-5"  style="font-weight: bold; text-color:color:#6c757d;;font-size:16px;margin-left:40px;">
                {{$invoice->company->website}}
              </p>
            </div>
          </div>
          <div class="fs-5 p-1 text-white bg-secondary text-center"  style="color: white; background-color:#6c757d;font-size:16px; text-align:center;">
